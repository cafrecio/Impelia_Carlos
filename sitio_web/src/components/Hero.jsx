      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 text-left space-y-6 md:space-y-8">
            ...
            {/* Elegant Pill Badge */}
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500/10 to-indigo-500/10 border border-blue-500/20 px-4 py-2 rounded-full text-xs font-semibold text-[#09c0a8] tracking-wide shadow-inner">
              <Zap className="h-4 w-4 text-[#09c0a8] animate-pulse" />
            ...
            <h1 className="font-display font-extrabold text-4xl sm:text-5xl lg:text-6xl text-white leading-[1.08] tracking-tight">
              ...
              <span className="text-[#09c0a8] font-display">
            ...
            <div className="pt-2 flex flex-col sm:flex-row gap-4 items-start sm:items-center">
              ...
              <a
                href="#como-ayuda"
                className="inline-flex items-center gap-2 text-[#09c0a8] hover:text-[#0cd1b7] font-semibold py-4 pr-6 text-sm sm:text-base transition-all duration-200 cursor-pointer group self-start"
              >
